...
def get_arguments():
	...
	parser.add_argument('-g', required = True, type = str, help='Genome file from whic contigs will be extracted', metavar='') # when using a single genome, -g is the name of genome file in .gbk (.gbff) format
